...
const Content_box2 = ({ imag, heading, onClick, customStyle, customHeading, onMouseOver, id }) => {
  ...
  return (
    <div id={id} className={`bg-[#F2F7FA] rounded-xl w-[45%] md:w-full  mb-5 py-[38px] px-3 hover:border border-#146FF8 cursor-pointer hover:scale-[1.0] ${customStyle}`} onClick={onClick} onMouseOver={onMouseOver}>
